  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="border-border/60 bg-card/40 mt-6 overflow-hidden rounded-xl border">
        {/* Table header */}
        <div className="border-border/60 bg-muted/20 text-muted-foreground hidden grid-cols-[3rem_1fr_auto_auto_auto] items-center gap-4 border-b px-5 py-2.5 text-[11px] font-semibold uppercase tracking-wider sm:grid">
              ...
              return (
                <li key={problem.slug}>
                  <Link
                    ...
                    className={cn(
                      'hover:bg-accent/5 group flex items-center gap-4 px-5 py-3.5 transition-colors',
                  ...
                  >
                    ...
                    <span className="text-muted-foreground w-8 shrink-0 text-right text-sm tabular-nums">
                      {solved ? (
                        <CheckCircle2 className="text-success h-4.5 w-4.5 ml-auto" />
                      ) : (
                        globalNum
                      )}
                    </span>
