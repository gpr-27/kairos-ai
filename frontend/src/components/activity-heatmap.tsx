      ...
      <div className="w-full select-none">
        ...
        <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
          <div className="text-sm">
            ...
            <span className="text-muted-foreground">
              {' '}
              · <span className="font-semibold">{totalSolved}</span> problem
            ...
            {[0, 1, 2, 3, 4, 5, 6].map((dow) => {
              ...
              return (
                <span
                  key={dow}
                  className={cn(
                    'text-muted-foreground absolute text-[10px] leading-none',
                ...
                {block.weeks.map((week, wIdx) => (
                  <div key={wIdx} style={{ display: 'flex', flexDirection: 'column', gap: GAP }}>
                    ...
                    <div style={{ height: MONTH_LBL_H, position: 'relative' }}>
                      {wIdx === 0 && (
                        <span
                          className="text-muted-foreground absolute left-0 top-0 whitespace-nowrap text-[11px] font-medium"
                    ...
                    {week.map((day, dow) => {
                      if (!day) {
                        ...
                        return (
                          <div key={dow} style={{ width: CELL, height: CELL, flexShrink: 0 }} />
                        );
                      }
                          ...
                          <TooltipTrigger asChild>
                            <div
                              style={{
                                ...
                                outlineOffset: '1px',
                                border: isFuture ? '1px solid rgba(255,255,255,0.04)' : 'none',
                              }}
                            />
                          </TooltipTrigger>
