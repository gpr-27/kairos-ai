  ...
  return (
    <div className="bg-background relative flex min-h-screen flex-col">
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute left-1/2 top-0 h-[500px] w-[900px] -translate-x-1/2 rounded-full bg-gradient-to-b from-violet-600/20 via-fuchsia-600/10 to-transparent blur-3xl" />
      </div>
