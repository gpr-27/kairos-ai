...
You may assume that each input has exactly one solution, and you may not use the same element twice.`,
    ...
    starterCode: { python: PYTHON_STARTER, cpp: CPP_STARTER, java: JAVA_STARTER, javascript: JS_STARTER },
    hints: [
...
You must write an algorithm with **O(log n)** runtime.`,
    constraints: ['1 ≤ nums.length ≤ 10⁴', 'All integers are unique.', 'Array is sorted ascending.'],
    examples: [
...

  {
    ...
    starterCode: { python: PYTHON_STARTER, cpp: CPP_STARTER, java: JAVA_STARTER, javascript: JS_STARTER },
    hints: [
      "Mark visited cells (e.g., '#') before recursing. Restore on backtrack.",
    ],
  },
...
You must do this **in-place** without making a copy of the array.`,
    ...
    starterCode: { python: PYTHON_STARTER, cpp: CPP_STARTER, java: JAVA_STARTER, javascript: JS_STARTER },
    hints: [
      'Use a slow pointer that tracks the next position to place a non-zero element.',
    ],
    acceptanceRate: 61,
  },

  {
    ...
    examples: [
      { input: 'nums = [3,0,1]', output: '2', explanation: 'n = 3, so range is [0,3]. Missing: 2.' },
...
For this problem, each list is given as a space-separated sequence of integers on a separate line.`,
    constraints: ['0 ≤ length ≤ 50', '-100 ≤ node value ≤ 100', 'Both lists are sorted in non-decreasing order.'],
    examples: [
      { input: 'list1 = [1,2,4], list2 = [1,3,4]', output: '1 1 2 3 4 4' },
      { input: 'list1 = [], list2 = []', output: '' },
    ],
    ioFormat: {
      input: 'Line 1: space-separated integers for list1 (empty line if empty)\nLine 2: space-separated integers for list2 (empty line if empty)',
...
The solution set must not contain duplicate triplets. Print each triplet on a new line, space-separated, sorted ascending.`,
    ...
    examples: [
      { input: 'nums = [-1,0,1,2,-1,-4]', output: '-1 -1 2\n-1 0 1', explanation: 'Two unique triplets.' },
      { input: 'nums = [0,0,0]', output: '0 0 0' },
    ],
    ioFormat: {
      input: 'Line 1: n (array length)\nLine 2: n space-separated integers',
      output: 'Each unique triplet on its own line, values sorted ascending, triplets sorted lexicographically',
    },
    visibleTestCases: [
...
Two strings are anagrams if one is a rearrangement of the other. Print each group on a separate line, words space-separated, words within a group sorted alphabetically, groups sorted by their first word.`,
    ...
    examples: [
      { input: 'strs = ["eat","tea","tan","ate","nat","bat"]', output: '"ate eat tea"\n"bat"\n"ant nat tan"' },
    ],
    ioFormat: {
      input: 'Line 1: n (number of strings)\nLine 2: n space-separated strings',
      output: 'Each anagram group on its own line, words sorted alphabetically, groups sorted by first word',
    },
    visibleTestCases: [
    ...
    starterCode: { python: PYTHON_STARTER, cpp: CPP_STARTER, java: JAVA_STARTER, javascript: JS_STARTER },
    hints: [
      'Sort each string to create a canonical key. Strings with the same key are anagrams.',
    ],
    acceptanceRate: 65,
  },
...
Each element \`nums[i]\` represents your **maximum jump length** from that position. Return \`true\` if you can reach the last index, \`false\` otherwise.`,
    ...
    examples: [
      { input: 'nums = [2,3,1,1,4]', output: 'true', explanation: 'Jump 1 step from 0 to 1, then 3 steps to last.' },
...

  {
    ...
    starterCode: { python: PYTHON_STARTER, cpp: CPP_STARTER, java: JAVA_STARTER, javascript: JS_STARTER },
    hints: [
      'Sort intervals by start time. Iterate and merge whenever current.start ≤ prev.end.',
    ],
    acceptanceRate: 46,
  },
...

  {
    ...
    constraints: ['m == s.length', 'n == t.length', '1 ≤ m, n ≤ 10⁵', 's and t consist of uppercase and lowercase letters.'],
    examples: [
...

  {
    ...
    examples: [
      { input: 'heights = [2,1,5,6,2,3]', output: '10', explanation: 'Bars at index 2 and 3 (height 5 and 6), width 2 → area 10.' },
...
6. Trade-offs in your design`,
    ...
    examples: [{ input: 'longUrl = "https://example.com/very/long/path"', output: 'shortUrl = "kairos.ai/k7Bq2"' }],
    starterCode: {},
    hints: [
...
5. Response when limit is exceeded (HTTP 429, headers)`,
    ...
    examples: [{ input: 'user makes 11 requests in 1 second, limit = 10/min', output: 'first 10 allowed, 11th → 429' }],
    starterCode: {},
    hints: [
